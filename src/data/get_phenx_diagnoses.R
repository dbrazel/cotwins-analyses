...
results$life_alc_abuse_count <- life_alc_failure + life_alc_hazard + life_alc_continue + life_alc_legal
results$life_alc_abuse <- results$life_alc_abuse_count >= 1

results$year_alc_abuse_count  <- year_alc_failure + year_alc_hazard + year_alc_continue + year_alc_legal
...
life_alc_withdrawal_count <- (phenx$PHXQ0031 == 1) + (phenx$PHXQ0033 == 1) + (phenx$PHXQ0035 == 1) + (phenx$PHXQ0037 == 1) + 
	(phenx$PHXQ0039 == 1) + (phenx$PHXQ0041 == 1) + (phenx$PHXQ0043 == 1) + (phenx$PHXQ0045 == 1)
year_alc_withdrawal_count <- (phenx$PHXQ0031 == 1 & phenx$PHXQ0032 == 1) + (phenx$PHXQ0033 == 1 & phenx$PHXQ0034 == 1) + 
	...
	(phenx$PHXQ0043 == 1 & phenx$PHXQ0044 == 1) + (phenx$PHXQ0045 == 1 & phenx$PHXQ0046 == 1)
...
results$life_alc_depend_count <- life_alc_tolerance + life_alc_quit + life_alc_intend + 
	life_alc_withdrawal + life_alc_time + life_alc_giveup + life_alc_problems
results$life_alc_depend <- results$life_alc_depend_count >= 3

results$year_alc_depend_count <- year_alc_tolerance + year_alc_quit + year_alc_intend + 
	year_alc_withdrawal + year_alc_time + year_alc_giveup + year_alc_problems
results$year_alc_depend <- results$year_alc_depend_count >= 3

# TODO Current cigarette dependence
...
life_tob_withdrawal_count <- (phenx$PHXQ0127 == 1) + (phenx$PHXQ0129 == 1) + (phenx$PHXQ0131 == 1) + (phenx$PHXQ0133 == 1) + 
	(phenx$PHXQ0135 == 1) + (phenx$PHXQ0137 == 1) + (phenx$PHXQ0139 == 1) + (phenx$PHXQ0141 == 1)
year_tob_withdrawal_count <- (phenx$PHXQ0127 == 1 & phenx$PHXQ0128 == 1) + (phenx$PHXQ0129 == 1 & phenx$PHXQ0130 == 1) + 
	...
	(phenx$PHXQ0139 == 1 & phenx$PHXQ0140 == 1) + (phenx$PHXQ0141 == 1 & phenx$PHXQ0142 == 1)
...
results$life_tob_depend_count <- life_tob_tolerance + life_tob_withdrawal + life_tob_intend + life_tob_quit +
	life_tob_giveup + life_tob_time + life_tob_problems
results$life_tob_depend <- results$life_tob_depend_count >= 3

results$year_tob_depend_count <- year_tob_tolerance + year_tob_withdrawal + year_tob_intend + year_tob_quit +
	year_tob_giveup + year_tob_time + year_tob_problems
