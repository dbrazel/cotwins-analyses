# Take the individual slopes and intercepts generated by ecig_per_week_linear_model.R and
...
params <- read_rds("data/models/ecig_linear_parameters.rds")
...
write_rds(var_comps, "data/models/ecig_linear_ACE_comps.rds")
