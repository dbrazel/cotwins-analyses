# Fit a linear growth model to drinking days per week using nlme and
...
# If the twin didn't use alcohol that week, set the pheno to 0
...
write_rds(re_est, "data/models/alc_freq_linear_random_effects.rds")
