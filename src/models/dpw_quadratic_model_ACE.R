...
# Fit the trivariate of the parameters and extract the a2, c2, and e2 estimates
print("Summary of the trivariate model for drinks per week:")
...
write_rds(var_comps, "data/models/dpw_quadratic_ACE_comps.rds")
