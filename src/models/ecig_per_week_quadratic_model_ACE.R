# Take the individual parameters generated by ecig_per_week_quadratic_model.R
# and use OpenMx to fit a trivariate ACE model
...
params <- read_rds("data/models/ecig_quadratic_parameters.rds")
...
write_rds(var_comps, "data/models/ecig_quadratic_ACE_comps.rds")
