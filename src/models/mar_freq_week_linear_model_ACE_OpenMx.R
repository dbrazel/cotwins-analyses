# Take the random slopes and intercepts generated by mar_freq_week_linear_model.R and
...
re_est <- read_rds("data/models/mar_freq_week_linear_random_effects.rds")
...
print("Summary of the univariate intercept model for marijuana frequency (days per week):")
...
print("Summary of the univariate slope model for marijuana frequency (days per week):")
...
print("Summary of the bivariate model of slope and intercept for marijuana frequency (days per week):")
