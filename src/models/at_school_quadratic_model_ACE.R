# Take the individual parameters generated by mar_per_week_quadratic_model.R
...
params <- read_rds("data/models/at_school_quadratic_parameters.rds")
...
write_rds(var_comps, "data/models/at_school_quadratic_ACE_comps.rds")
