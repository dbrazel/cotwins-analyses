...
ggplot(remote_sub_use_age, aes(x = age_at_completion, y = alc_quantity_drinks_per_day)) + geom_smooth(method = "lm") + xlab("Age in Years") + ylab("Drinks per Day")
```
...
ggplot(remote_sub_use_age, aes(x = age_at_completion, y = mar_freq_times_per_day)) + geom_smooth(method = "lm") + xlab("Age in Years") + ylab("Marijuana Use, Times per Day")
```
...
ggplot(remote_sub_use_age, aes(x = age_at_completion, y = cig_quantity_per_day)) + geom_smooth(method = "lm") + xlab("Age in Years") + ylab("Cigarettes per Day")
```
...
ggplot(remote_sub_use_age, aes(x = age_at_completion, y = ecig_quantity_puffs)) + geom_smooth(method = "lm") + xlab("Age in Years") + ylab("E-Cigarette Puffs per Use")
```
...
ggplot(remote_sub_use_age, aes(x = age_at_completion, y = ecig_freq_times_per_day)) + geom_smooth(method = "lm") + xlab("Age in Years") + ylab("E-Cigarette Uses per Day")
```
